...
public class PreComputeNNs {
    ...
    public PreComputeNNs(String propPath) throws Exception {
        ...
        if(prop.getProperty("vectorPath")!=null) {
            ...
            k = Integer.parseInt(prop.getProperty("k", "5"));
    ...
    public void computeAndStoreQueryNNs() throws FileNotFoundException, SAXException, Exception {
        ...
        EnglishAnalyzerSmartStopWords engAnalyzer = new EnglishAnalyzerSmartStopWords("/home/dwaipayan/smart-stopwords");
...
//            }
    ...
    public static void main(String[] args) {
        ...
        args = new String[1];
        args[0] = "/home/suchana/NetBeansProjects/NeuralModelQpp/preComputedNNs.properties";
