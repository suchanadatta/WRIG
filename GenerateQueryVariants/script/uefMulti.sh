...
then
    ...
    echo "9. Number of clusters.";
    echo "10. Size of the cluster.";
    exit 1;
fi
...
# Size of the cluster to be chosen
sizeCluster=$10
...
java -Xmx1g -cp $CLASSPATH:dist/NeuralModelQpp.jar baselines.UEFMultiCluster $prop_name
